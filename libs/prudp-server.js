...
/**
 * Class that represents a prudp server
 * 
 * @fires PRUDPServer#listening
 * @fires PRUDPServer#connection
 * @fires PRUDPServer#error
 */
...
/**
 * Listening event.
 * @event PRUDPServer#listening
 * @type {object}
 */
/**
 * error event.
 * Fired when an error happens on the server
 * @event PRUDPServer#error
 * @type {object}
 * @property {Error} err The error generated by the server
 * @property {object} data The data that generated the error
 */
/**
 * connection event.
 * Fired when a client connects to the server
 * @event PRUDPServer#connection
 * @type {object}
 * @property {PRUDP} client The client that connected to the server
 */
